...
public enum SuccessStatus implements BaseCode {
    ...
    LOGOUT_SUCCESS(HttpStatus.NO_CONTENT, "1004", "로그아웃이 완료되었습니다."),

    USER_FETCHED(HttpStatus.OK, "1005", "회원 정보 조회에 성공했습니다."),
    USER_UPDATED(HttpStatus.NO_CONTENT, "1006", "회원 정보 수정에 성공했습니다."),
    PASSWORD_UPDATE(HttpStatus.NO_CONTENT, "1007", "비밀번호 수정에 성공했습니다."),
    USER_DELETED(HttpStatus.NO_CONTENT, "1008", "회원 탈퇴가 완료되었습니다."),
    ...
    STORE_UPDATED(HttpStatus.NO_CONTENT, "1013", "가게 정보 수정이 완료되었습니다."),
    STORE_DELETED(HttpStatus.NO_CONTENT, "1014", "가게 삭제가 완료되었습니다."),

    MENU_CREATED(HttpStatus.CREATED, "1015", "메뉴가 성공적으로 생성되었습니다."),
    MENU_UPDATED(HttpStatus.NO_CONTENT, "1016", "메뉴가 성공적으로 수정되었습니다."),
    MENU_DELETED(HttpStatus.NO_CONTENT, "1017", "메뉴가 성공적으로 삭제되었습니다."),

    CART_ITEM_ADDED(HttpStatus.CREATED, "1018", "장바구니에 메뉴가 추가되었습니다."),
    CART_ITEM_FETCHED(HttpStatus.OK, "1019", "장바구니의 메뉴가 성공적으로 조회되었습니다."),
    CART_ITEM_UPDATED(HttpStatus.NO_CONTENT, "1020", "장바구니에서 선택한 메뉴의 수량이 변경되었습니다."),
    CART_CLEARED(HttpStatus.NO_CONTENT, "1021", "장바구니가 비워졌습니다."),
    ...
    REVIEW_UPDATED(HttpStatus.NO_CONTENT, "1028", "리뷰가 성공적으로 수정되었습니다."),
    REVIEW_DELETED(HttpStatus.NO_CONTENT, "1029", "리뷰가 성공적으로 삭제되었습니다."),
